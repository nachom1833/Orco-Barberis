      ...
      {isOpen && project && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-4xl bg-brand-beige border border-brand-olive/10 rounded-3xl shadow-2xl z-10 overflow-hidden flex flex-col max-h-[calc(100vh-2rem)]"
          >
            {/* Close Button */}
            <button
              onClick={onClose}
              className="absolute top-4 right-4 sm:top-6 sm:right-6 p-2 rounded-full bg-brand-beige-dark/90 text-brand-olive/70 hover-hover:text-brand-olive hover-hover:bg-brand-olive/10 transition-colors duration-200 z-20 backdrop-blur-sm shadow-sm"
            ...
            <div className="overflow-y-auto p-6 sm:p-8 md:p-10 w-full h-full overscroll-contain">
              {/* Layout Grid */}
